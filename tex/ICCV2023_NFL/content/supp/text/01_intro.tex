...
\input{\subdir/content/supp/figures/diverged_beam}
...
\begin{figure}[!t]
    \centering
        \includegraphics[width=1.0\columnwidth]{content/main/images/rebuttal_secondary_return.pdf}
...
\input{\subdir/content/supp/tabs/ablate_two_return_mask}
...
\input{\subdir/content/supp/tabs/interp_segmentation}
...
\input{\subdir/content/supp/tabs/nvs_main}
\input{\subdir/content/supp/tabs/ablate_vol_render}
\input{\subdir/content/supp/tabs/nvs_registration}
\input{\subdir/content/supp/tabs/nvs_segmentation}
...
\clearpage
\input{\subdir/content/supp/figures/town_dataset}
\input{\subdir/content/supp/figures/waymo_dataset}
\input{\subdir/content/supp/figures/lidarsim_raydrop}
\input{\subdir/content/supp/figures/ablate_two_return_mask}

\input{\subdir/content/supp/figures/townclean}
\input{\subdir/content/supp/figures/townreal}
\input{\subdir/content/supp/figures/waymo_nvs}
\input{\subdir/content/supp/figures/waymo_interp}
